...
export default function Home() {
  ...
  // ── Tool ───────────────────────────────────────────────────────────────────
  return (
    <main className="relative min-h-screen py-10 px-3 sm:px-6 overflow-x-hidden" style={{ background: "var(--page-bg)" }}>
        ...
        {(() => {
          const socialIcons = (
            <div className="flex items-center gap-1.5">
              <a href="https://youtube.com/@investwithbjorn" target="_blank" rel="noopener noreferrer"
                ...
                style={{ background: "var(--secondary-bg)", border: "1px solid var(--secondary-border)", color: "var(--secondary-color)", opacity: 0.75 }}
                title="YouTube">
          ...
          const themeBtn = (
            <button
              ...
              style={{ background: "var(--secondary-bg)", border: "1px solid var(--secondary-border)", color: "var(--secondary-color)" }}
            ...
            <div className="mb-8 fade-in-up">
              ...
              <div className="sm:hidden flex items-start justify-between mb-1">
                <div className="text-left">
                  ...
                  <p className="text-sm" style={{ color: "var(--secondary-color)" }}>A simple way to assess the health and quality of a business.</p>
                </div>
                {themeBtn}
              </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8 items-center sm:justify-center fade-in-up relative z-10">
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="rounded-xl px-4 py-3 pr-10 text-sm w-full outline-none transition-all"
              style={{ background: "var(--input-bg)", border: "1px solid var(--input-border)", color: "var(--input-text)" }}
              onFocus={e => e.currentTarget.style.border = "1px solid rgba(212,169,60,0.7)"}
              onBlur={e => e.currentTarget.style.border = "1px solid var(--input-border)"}
            />
            ...
            {showSearchTip && (
              ...
              >
                <p className="font-semibold mb-2" style={{ color: "var(--text-primary)" }}>Searching international stocks</p>
                <p className="mb-2" style={{ color: "var(--tooltip-label)" }}>Add the exchange suffix after the ticker:</p>
      ...
      {/* Footer */}
      <footer className="relative mt-12 flex flex-col items-center gap-3 text-sm" style={{ color: "var(--text-muted)" }}>
        <span>
          Built by{" "}
          <a
